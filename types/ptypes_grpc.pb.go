...
type AggregatorClient interface {
	Aggregate(ctx context.Context, in *AggregateReq, opts ...grpc.CallOption) (*None, error)
	GetInvoice(ctx context.Context, in *GetInvoiceReq, opts ...grpc.CallOption) (*InvoiceRes, error)
}
...
func (c *aggregatorClient) Aggregate(ctx context.Context, in *AggregateReq, opts ...grpc.CallOption) (*None, error) {
	out := new(None)
...
func (c *aggregatorClient) GetInvoice(ctx context.Context, in *GetInvoiceReq, opts ...grpc.CallOption) (*InvoiceRes, error) {
	out := new(InvoiceRes)
...
type AggregatorServer interface {
	Aggregate(context.Context, *AggregateReq) (*None, error)
	GetInvoice(context.Context, *GetInvoiceReq) (*InvoiceRes, error)
...
func (UnimplementedAggregatorServer) Aggregate(context.Context, *AggregateReq) (*None, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Aggregate not implemented")
}
func (UnimplementedAggregatorServer) GetInvoice(context.Context, *GetInvoiceReq) (*InvoiceRes, error) {
...
func _Aggregator_Aggregate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AggregatorServer).Aggregate(ctx, req.(*AggregateReq))
	}
...
func _Aggregator_GetInvoice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AggregatorServer).GetInvoice(ctx, req.(*GetInvoiceReq))
	}
	return interceptor(ctx, in, info, handler)
}
